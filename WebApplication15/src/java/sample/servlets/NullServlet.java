        ...
        try {
            ...
            if (cookies != null) {
                for (Cookie cookie:cookies) {
                    ...
                    String passwork = cookie.getValue();
                    
                    listOfUsernameDAO dao = new listOfUsernameDAO();
                    boolean result = dao.checkLogin(username, passwork);
                    if (result) {
                        url = searchPage;
                    }
                } //end for
            ...
            response.sendRedirect(url); // both SendRedirect or Request Dispatcher are OK
            out.close();
        }
    }
