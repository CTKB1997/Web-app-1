...
import sample.listofusername.listOfUsernameDTO;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (searchValue.trim().length() > 0) {
                ...
                List<listOfUsernameDTO> result = dao.getListAccounts();
            ...
            RequestDispatcher rp = request.getRequestDispatcher(showSearchResultServlet);
